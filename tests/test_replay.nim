...
const
  ...
  # (GameVersion 47, seed 6, tools/record_fixture.sh). This capture-ending
  ...
  # GameVersion 47, seed 907, lives 9 — see
  # test_extract_events.)
  CtfReplayPath = GameDir / "tests" / "fixtures" / "capture-seed6.bitreplay"
